...
const Header = () => {
  ...
  return (
    <header
      className={`${active ? "py-1 bg-white shadow-md" : "py-2"} max-padd-container fixed top-0 w-full left-0 right-0 z-50 transition-all duration-200`}
    >
      {/* CONTAINER */}
      <div className="flexBetween">
        ...
        <div>
          <Link to={"/"}>
            <img src={logo} alt="Logo" className="h-24 mix-blend-multiply" />
          </Link>
        </div>
        {/* NAVBAR */}
